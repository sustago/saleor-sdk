...
export interface CreateCheckoutPayment_checkoutPaymentCreate_checkout_lines_variant_attributes_attribute_metadata {
...
export interface CreateCheckoutPayment_checkoutPaymentCreate_checkout_lines_variant_attributes_attribute {
   ...
   */
  metadata: (CreateCheckoutPayment_checkoutPaymentCreate_checkout_lines_variant_attributes_attribute_metadata | null)[];
}
