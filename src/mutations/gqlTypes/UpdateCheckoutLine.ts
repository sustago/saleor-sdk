...
export interface UpdateCheckoutLine_checkoutLinesUpdate_checkout_lines_variant_attributes_attribute_metadata {
...
export interface UpdateCheckoutLine_checkoutLinesUpdate_checkout_lines_variant_attributes_attribute {
   ...
   */
  metadata: (UpdateCheckoutLine_checkoutLinesUpdate_checkout_lines_variant_attributes_attribute_metadata | null)[];
}
