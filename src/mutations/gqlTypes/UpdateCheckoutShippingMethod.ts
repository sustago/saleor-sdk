...
export interface UpdateCheckoutShippingMethod_checkoutShippingMethodUpdate_checkout_lines_variant_attributes_attribute_metadata {
...
export interface UpdateCheckoutShippingMethod_checkoutShippingMethodUpdate_checkout_lines_variant_attributes_attribute {
   ...
   */
  metadata: (UpdateCheckoutShippingMethod_checkoutShippingMethodUpdate_checkout_lines_variant_attributes_attribute_metadata | null)[];
}
...
export interface UpdateCheckoutShippingMethod_checkoutShippingMethodUpdate_checkout_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface UpdateCheckoutShippingMethod_checkoutShippingMethodUpdate_checkout {
   ...
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (UpdateCheckoutShippingMethod_checkoutShippingMethodUpdate_checkout_metadata | null)[];
}
