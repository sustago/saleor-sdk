...
export interface CreateCheckout_checkoutCreate_checkout_lines_variant_attributes_attribute_metadata {
...
export interface CreateCheckout_checkoutCreate_checkout_lines_variant_attributes_attribute {
   ...
   */
  metadata: (CreateCheckout_checkoutCreate_checkout_lines_variant_attributes_attribute_metadata | null)[];
}
