...
export interface UserOrderByToken_orderByToken_lines_variant_attributes_attribute_metadata {
...
export interface UserOrderByToken_orderByToken_lines_variant_attributes_attribute {
   ...
   */
  metadata: (UserOrderByToken_orderByToken_lines_variant_attributes_attribute_metadata | null)[];
}
